...
describe('brotliCompression with intermediate Response', () => {
  ...
  it('should set Vary: Accept-Encoding if not present on intermediate Response even if brotli (br) is not supported', async () => {
    const request = new Request('https://example.com');
    request.headers.delete(ACCEPT_ENCODING);
  ...
  it('should append Accept-Encoding to Vary header if header already present on intermediate Response without Accept-Encoding even if brotli (br) is not supported', async () => {
    const request = new Request('https://example.com');
    request.headers.delete(ACCEPT_ENCODING);
